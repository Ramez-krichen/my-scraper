...
def main():
  product_list = Path("extractors/mock_data/emtop/product-list.html").read_text(encoding="utf-8")
  products = extract_product_list_items(product_list, "https://emtoptunisie.com/product-category/outils-sans-fil/")
  return products
